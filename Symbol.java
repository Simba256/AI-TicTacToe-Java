...
public class Symbol implements SymbolInterface, Cloneable, Comparable
{
	...
	*/
	protected Symbol(SymbolValue s)
	{
		...
		symbol = s;                      // Initialize symbol with the given SymbolValue
	...
	*/
	protected void setSymbol(SymbolValue s)
	{
		...
		symbol = s;                      // Set the symbol to the specified SymbolValue
	...
	*/
	public void makeEmpty()
	{
		...
		this.symbol = SymbolValue.EMPTY;  // Set symbol to EMPTY
	...
	*/
	protected SymbolValue getSymbol()
	{
		...
		return symbol;                   // Return the current SymbolValue
	}
	...
	*/
	public boolean isEmpty()
	{
		...
		if (symbol != SymbolValue.CROSS && symbol != SymbolValue.NOUGHT) 
		{
			return true;                 // Return true if symbol is neither CROSS nor NOUGHT
    	}

		return false;                    // Otherwise Symbol is not empty
	}
	...
	*/
	public boolean equals(Symbol s)
	{
		...
		if(s.symbol == symbol) return true; // Check if this symbol equals the specified symbol

		return false;                       // Otherwise Symbols are not equal
	}
	...
	*/
	public String toString()
	{
		...
		else
		{
			...
			else if(this.equals(new Symbol(SymbolValue.NOUGHT)))
      		{
      			trace("toString: toString ends (O)");
				return "O";
			}else{
				trace("This is something new!!!");
				return "Empty";
			}
		}
	}
