...
{	
	...
	*/
	public Square(Location l)
	{
		...
		this.loc = l;                   // Set the location for this square
		this.symbol = new Symbol();     // Initialize the symbol as a new Symbol instance
	...
	*/
	public Square(Location l,Symbol s)
	{
		...
		this.loc = l;                   // Set the location for this square
		this.symbol = s;                // Set the symbol for this square
	...
	*/
	public Object clone()
	{
		...
		Location locClone = (Location) loc.clone();  // Clone the location of this square
		Symbol symbolClone = (Symbol) symbol.clone();  // Clone the symbol of this square

		s = new Square(locClone, symbolClone);  // Create a new Square with cloned location and symbol
	...
	*/
	public boolean isEmpty()
	{
		...
		if(symbol.equals(empty)) return true;  // Check if the square's symbol is equal to an empty symbol
		return false;                     // Otherwise Square is not empty
	}
