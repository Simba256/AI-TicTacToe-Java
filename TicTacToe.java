				...
				else
				{
					...
					if (! board.gameOver())
					{
				        ...
				        if (depthFirst)
				        {
							...
							s=new Stack();
							trace("Human symbol:");
							HUMAN.getSymbol().toString();
		  	      			game.buildGameDF(s,HUMAN,lookAhead);
							if(game.isEmpty()) trace("Game empty after DF in TicTacToe.java");
							if(game.getChild().isEmpty()) trace("Game child empty after DF in TicTacToe.java");
		  	      		}				
		  	      		else
		  	      		{
  						...
  						game.traverse();
						if(game.getChild().isEmpty()) trace("Game child empty in TicTacToe.java");
