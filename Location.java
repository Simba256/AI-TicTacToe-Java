...
public class Location implements LocationInterface, Cloneable
{
	...
	*/
	public Location(int r, int c)
	{
		...
		this.row = r;          // Set the row for the location
    	this.column = c;       // Set the column for the location
	...
	*/
	public void setRow(int r)
	{
    	...
    	this.row = r;          // Update the row value of this location
	...
	*/
	public void setColumn(int c)
	{
		...
		this.column = c;       // Update the column value of this location
	...
	*/
	public int getRow()
	{
		...
		return row;            // Return the current row value
	}
	...
	*/
	public int getColumn()
	{
		...
		return column;         // Return the current column value
	}
	...
	*/
	public Object clone()
	{
		...
		l = new Location(this.row, this.column);  // Create a new Location with the same row and column
