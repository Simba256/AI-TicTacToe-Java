...
public class Stack implements StackInterface
{
	...
	*/
	public boolean isEmpty()
	{
		...
		if(this.tos == null) return true; // Check if top of stack is null, indicating an empty stack
	...
	*/
	public Object top() throws EmptyStackException
	{
		...
		else
		{
			...
			trace("top: top ends");
			return this.tos.getData();        // Return data of the top element in the stack
		}
	}
	...
	*/
	public void pop() throws EmptyStackException
	{
		...
		else
		{
			...
			this.tos = this.tos.getNext();    // Remove the top element by updating tos to the next node
		}
	...
	*/
	public void push(Object o)
	{
		...
		n.setNext(this.tos);              // Link new node to the current top of stack

		this.tos = n;                     // Set new node as the top of stack
